...
function Strategy(options, verify) {
  options = options || {};
  options.permission = options.permission || 'read'
  ...
  options.userAuthorizationURL = options.userAuthorizationURL || 'https://www.flickr.com/services/oauth/authorize?perms=' + options.permission;
